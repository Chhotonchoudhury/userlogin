			...
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					<form action="<?= base_url('user/check'); ?>" method="post">
						...
						<div class="input-group mb-3">
							...
							<input type="text" name="email" class="form-control input_user" value="<?= set_value('email') ?>" placeholder="username">
						</div>
						...
						<div class="input-group mb-2">
							...
							<input type="password" name="password" class="form-control input_pass" value="<?= set_value('password') ?>" value="" placeholder="password">
						</div>
				...
				<div class="mt-4">
					<div class="d-flex justify-content-center links">
						Don't have an account? <a href="<?php echo base_url('user/reg'); ?>" class="ml-2">Sign Up</a>
					</div>
					<div class="d-flex justify-content-center links">
